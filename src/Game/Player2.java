...
public class Player2 extends Entity {
    private static final float APPEARANCE_X = Entity.SPRITE_SCALE * Game.SCALE * 8;
    ...
    public Player2(float scale , float speed , TextureAtlas atlas , Level lvl) {
    ...
    public void update(Input input) {
        ...
        if (input.getKey(KeyEvent.VK_SPACE)) {
            if (bullet == null || !bullet.isActive()) {
                if (Game.getBullets(EntityType.Player2).size() == 0) {
    ...
    public void reset() {
        if (!intersectsEnemy(APPEARANCE_X, APPEARANCE_Y)) {
            this.x = APPEARANCE_X;
            this.y = APPEARANCE_Y;
            isAlive = true;
            evolving = true;
    ...
    private enum Heading {
        NORTH(0 * SPRITE_SCALE , 4 * SPRITE_SCALE , 1 * SPRITE_SCALE , 2 * SPRITE_SCALE),
        EAST(6 * SPRITE_SCALE , 4 * SPRITE_SCALE , 1 * SPRITE_SCALE , 2 * SPRITE_SCALE),
        SOUTH(4 * SPRITE_SCALE , 4 * SPRITE_SCALE , 1 * SPRITE_SCALE , 2 * SPRITE_SCALE),
        WEST(2 * SPRITE_SCALE , 4 * SPRITE_SCALE , 1 * SPRITE_SCALE , 2 * SPRITE_SCALE);
