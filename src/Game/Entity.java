...
public abstract class Entity {
    ...
    public static final int SPRITES_PER_HEADING_FOR_ENTITY = 2;
    ...
    protected Entity(EntityType type , float x , float y ,float scale , TextureAtlas atlas , Level lvl) {
        ...
        evolvingList.add(
                new Sprite(new SpriteSheet(atlas.cut(16 * SPRITE_SCALE , 6 * SPRITE_SCALE , 2* SPRITE_SCALE ,2* SPRITE_SCALE) ,
                        SPRITES_PER_HEADING , SPRITE_SCALE) , scale));
        evolvingList.add(
                new Sprite(new SpriteSheet(atlas.cut(17 * SPRITE_SCALE , 6 * SPRITE_SCALE , 2* SPRITE_SCALE , 2*SPRITE_SCALE) ,
                        SPRITES_PER_HEADING , SPRITE_SCALE) , scale));
        evolvingList.add(
                new Sprite(new SpriteSheet(atlas.cut(18 * SPRITE_SCALE , 6 * SPRITE_SCALE , 2* SPRITE_SCALE ,2* SPRITE_SCALE) ,
                        SPRITES_PER_HEADING , SPRITE_SCALE) , scale));
        evolvingList.add(
                new Sprite(new SpriteSheet(atlas.cut(19 * SPRITE_SCALE , 6 * SPRITE_SCALE , 2* SPRITE_SCALE , 2*SPRITE_SCALE) ,
                        SPRITES_PER_HEADING , SPRITE_SCALE) , scale));
    }
